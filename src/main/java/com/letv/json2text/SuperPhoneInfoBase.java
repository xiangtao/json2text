...
public class SuperPhoneInfoBase {
	protected Id _id;
	protected String imei;
	protected String imei2;
	protected String sn;
	protected String meid;
	protected String ui_version;
	protected String software_version;
	protected String hardware_version;
	protected String head_code;
	protected String motherboard_code;
	protected String repair;
	protected String product_date;
	protected String shipping_date;
	protected String pcb_sn;
	protected String production_number;
	protected String letv_part_number;
	protected String plan_id;
	protected String factory_part_number;
	protected String sale_area;
	protected String send_time;
	protected String factory_delivery_time;
	protected String factory;
	protected String factory_delivery_id;
	protected String activation_time;
	protected String activation_halfhour_time;
//	protected String factory_send_date;
	protected String status;
	protected String activation_halfhour_mobile;
	protected String plan_create_username;
	protected String plan_create_time;
	protected String model;
//	protected GroupId group_id;
	protected String send_username;
	protected String godown_entry_id;
	protected String description;
	protected String external_model;
	...
	public String toString() {
		return "SuperPhoneInfo [_id=" + _id + ", imei=" + imei + ", imei2="
				...
				+ plan_create_time + ", model=" + model + ", send_username=" + send_username
